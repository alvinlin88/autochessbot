module.exports = {
  ...
  getp: require("./admin/getp"),
  gets: require("./admin/gets"),
  ...
  cancel: require("./lobbies/cancel"),
  clearlobbies: require("./lobbies/clearlobbies"),
  getpass: require("./lobbies/getpass"),
  host: require("./lobbies/host"),
  join: require("./lobbies/join"),
  kick: require("./lobbies/kick"),
  leave: require("./lobbies/leave"),
  list: require("./lobbies/list"),
  lobby: require("./lobbies/lobby"),
  lobbyinfo: require("./lobbies/lobbyinfo"),
  removelobby: require("./lobbies/removelobby"),
  savelobbies: require("./lobbies/savelobbies"),
  ...
  setactivetournament: require("./tournaments/setactivetournament"),
