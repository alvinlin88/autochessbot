...
describe('ArgumentParsingTest', () => {
    ...
    it('Not enough args', () => {
        ...
        expect(optionalMulti.parseArgs(["123", "blah", "blah"])).to.deep.equal({testArg1: "123", testArg3: ["blah", "blah"]});
        expect(() => requiredMulti.parseArgs(["123"])).to.throw('Not enough args');
        expect(requiredMulti.parseArgs(["123", "blah", "blah"])).to.deep.equal({testArg1: "123", testArg4: ["blah", "blah"]});
