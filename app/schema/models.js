...
const models = {
  ...
  VerifiedSteam: dbInstance.define("verifiedSteam", {
    steam: {
      type: Sequelize.TEXT,
      unique: true,
      allowNull: false
...
models.Tournament.hasMany(models.TournamentRegistration, {
  foreignKey: "fk_tournament"
})
models.TournamentRegistration.belongsTo(models.Tournament, {
  foreignKey: "fk_tournament"
})
